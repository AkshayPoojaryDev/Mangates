  ...
  //       description: 'SEO, SEM, social media and more.',
  //       image: marketingImg,
  //       price: 89,
  //     },
  //     {
  ...
  //               desc: 'Study at your own pace with access to materials 24/7.',
  //             },
  //             {
  ...
  //                 name: 'Emily R.',
  //                 feedback:
  //                   'This platform helped me get certified and land my dream job. The instructors are top‑notch!',
  //               },
  //               {
  //                 name: 'James W.',
  //                 feedback:
  //                   'Great content, flexible schedule, and amazing support team. Highly recommend to everyone.',
  //               },
  //             ].map((t, idx) => (
